...
from model_spelt.SPELT import SPELT
...
from utils_lzl import model_utils
from utils_lzl.eval_print_utils import print_eval_runs
...
od_eval_model = ["iforest", "copod", "hbos", 'rod', 'mcd', 'ecod']  # we obtain ground-truth annotations using three outlier detection methods
runs = args.runs
...
def run_model(algorithm, X, y):
    if algorithm == "SPELT":
        model = SPELT(verbose=False, gpu=args.gpu,
