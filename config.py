...
def get_parser(algorithm_name, parser):
    if algorithm_name == "SPELT":
        parser.add_argument('--nbrs_num', type=int, default=30, help='')
        parser.add_argument('--rand_num', type=int, default=30, help='')
        parser.add_argument('--alpha1', type=float, default=0.4, help='triplet loss factor in loss function')
        parser.add_argument('--alpha2', type=float, default=0.6, help='dis loss factor in loss function')
        parser.add_argument('--n_epoch', type=int, default=10, help='')
        parser.add_argument('--batch_size', type=int, default=512, help='')
        parser.add_argument('--lr', type=float, default=0.1, help='')
        parser.add_argument('--n_linear', type=int, default=256, help='')
